  ...
  public static class LayoutParams extends ViewGroup.MarginLayoutParams {
    ...
    LayoutParams(Context context, AttributeSet attrs) {
      ...
      final TypedArray a = context.obtainStyledAttributes(attrs,
          android.support.design.R.styleable.CoordinatorLayout_LayoutParams);

      this.gravity = a.getInteger(
          android.support.design.R.styleable.CoordinatorLayout_LayoutParams_android_layout_gravity,
          Gravity.NO_GRAVITY);
      mAnchorId = a.getResourceId(android.support.design.R.styleable.CoordinatorLayout_LayoutParams_layout_anchor,
          View.NO_ID);
      this.anchorGravity = a.getInteger(
          android.support.design.R.styleable.CoordinatorLayout_LayoutParams_layout_anchorGravity,
          Gravity.NO_GRAVITY);

      this.keyline = a.getInteger(android.support.design.R.styleable.CoordinatorLayout_LayoutParams_layout_keyline,
          -1);

      mBehaviorResolved = a.hasValue(
          android.support.design.R.styleable.CoordinatorLayout_LayoutParams_layout_behavior);
