...
/**
 * The {@link android.support.design.widget.CoordinatorLayout.Behavior} for a scrolling view that is positioned vertically below another view.
...
abstract class HeaderScrollingViewBehavior extends ViewOffsetBehavior<View> {
  ...
  final int getOverlapPixelsForOffset(final View header) {
    return mOverlayTop == 0
        ? 0
        : HeaderBehavior.MathUtils.constrain(Math.round(getOverlapRatioForOffset(header) * mOverlayTop),
        0, mOverlayTop);
